...
<head>
    ...
    <!-- css -->
    <link href="<c:url value='/template/web/css/material-kit.css?v=2.0.7' />" rel="stylesheet" type="text/css"
          media="all"/>
...
<div class="main main-raised pb-4" style="min-width: 500px;">
    <div class="container pb-4 " style="max-width: 1540px;">
        <div class="w-100">
            <dec:body/>
        </div>
    </div>
...
<script type="text/javascript" src="<c:url value='/template/web/js/material-kit.js' />"></script>
